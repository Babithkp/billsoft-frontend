import { RxCube } from "react-icons/rx";import { TbInvoice } from "react-icons/tb";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function InventryPage() {
  ...
  const [filteredItem, setFilteredItem] = useState<ItemInputs[]>([]);
  ...
  const setValuesToInputs = (item: ItemInputs) => {
    ...
    setValue("purchaseQty", item.purchaseQty);
          ...
          <div className="flex w-full rounded-xl bg-[#FAFAFA] p-5 shadow-md">
            <div className="flex items-center gap-5">
              ...
              <div className="font-medium">
                ...
                <p className="text-xl text-[#007E3B]">INR 121</p>
              </div>
            </div>
          </div>
          <div className="flex w-full rounded-xl bg-[#FAFAFA] p-5 shadow-md">
            <div className="flex items-center gap-5">
              ...
              <div className="font-medium">
                ...
                <p className="text-xl text-[#007E3B]">INR 10</p>
              </div>
            </div>
          </div>
          <div className="flex w-full rounded-xl bg-[#FAFAFA] p-5 shadow-md">
                  ...
                  >
                    ...
                    <div className="w-[18%]">
                      <div className="flex flex-col gap-2">
                        ...
                        <input
                          className="border-primary rounded-md border p-1 py-2 pl-2"
                          {...register("purchaseQty", { required: true })}
                        />
                      </div>
                      {errors.purchaseQty && (
                        <p className="text-red-500">Purchase Qty is required</p>
                      )}
                    </div>
                    <div className="w-[18%]">
                      <div className="flex flex-col gap-2">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            ...
                            >
                              <SelectTrigger className="w-full border-primary data-placeholder:text-black py-5">
                                <SelectValue
        ...
        <table className={`w-full`}>
          <thead>
            <tr>
              ...
              <th className="text-center font-medium text-muted">
          ...
          <tbody>
            {filteredItem.map((item) => (
              ...
              >
                ...
                <td className="py-2">
                  INR{" "}
                  {((item.sellingPrice * parseFloat(item.tax)) / 100).toFixed(
                    2
                  )}
                </td>
                <td className="py-2 text-center">INR {item.sellingPrice}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <DialogContent className="min-w-6xl">
          ...
          <div className="grid grid-cols-4 gap-5">
            ...
            <div className=" flex items-center gap-5">
              ...
              <p>INR {selectedItem?.purchaseQty}</p>
            </div>
            ...
            <div className="flex items-center gap-5">
              <label className="font-medium">Purchase Value (per unit)</label>
              <p>{selectedItem?.purchasePrice}</p>
            </div>
            <div className="flex items-center gap-5">
